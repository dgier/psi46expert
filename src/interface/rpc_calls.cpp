// RPC functions
// created: 27.12.2013 14:59:44
// This is an auto generated file
// *** DO NOT EDIT THIS FILE ***

#include "pxar_rpc.h"

const char CTestboard::rpc_timestamp[] = "27.12.2013 14:59:44";

const unsigned int CTestboard::rpc_cmdListSize = 97;
...
const char *CTestboard::rpc_cmdName[] =
{
	...
	/*    90 */ "ChipThreshold$iiiiiiii0i0i",
	/*    91 */ "ChipThresholdIntern$v0iiiiiii0i0i",
	/*    92 */ "SCurve$iiii0i",
	/*    93 */ "SCurve$iii0i0i0i",
	/*    94 */ "SCurveColumn$iiii0i0i0i0i",
	/*    95 */ "PH$iiiis",
...
int32_t CTestboard::ChipThreshold(int32_t rpc_par1, int32_t rpc_par2, int32_t rpc_par3, int32_t rpc_par4, int32_t rpc_par5, int32_t rpc_par6, int32_t rpc_par7, int32_t &rpc_par8, int32_t &rpc_par9)
{ RPC_PROFILING
	int32_t rpc_par0;
	try {
	...
	rpc_io->Flush();
	msg.Receive(*rpc_io);
	msg.Check(rpc_clientCallId,12);
	rpc_par0 = msg.Get_INT32();
	rpc_par8 = msg.Get_INT32();
	rpc_par9 = msg.Get_INT32();
	RPC_THREAD_UNLOCK
	} catch (CRpcError &e) { e.SetFunction(90); throw; };
	return rpc_par0;
}

void CTestboard::ChipThresholdIntern(int32_t &rpc_par1, int32_t rpc_par2, int32_t rpc_par3, int32_t rpc_par4, int32_t rpc_par5, int32_t rpc_par6, int32_t rpc_par7, int32_t &rpc_par8, int32_t &rpc_par9)
{ RPC_PROFILING
	try {
...
int32_t CTestboard::SCurve(int32_t rpc_par1, int32_t rpc_par2, int32_t rpc_par3, int32_t &rpc_par4)
{ RPC_PROFILING
	int32_t rpc_par0;
	try {
	...
	rpc_io->Flush();
	msg.Receive(*rpc_io);
	msg.Check(rpc_clientCallId,8);
	rpc_par0 = msg.Get_INT32();
	rpc_par4 = msg.Get_INT32();
	RPC_THREAD_UNLOCK
	} catch (CRpcError &e) { e.SetFunction(92); throw; };
	return rpc_par0;
}

int32_t CTestboard::SCurve(int32_t rpc_par1, int32_t rpc_par2, int32_t &rpc_par3, int32_t &rpc_par4, int32_t &rpc_par5)
{ RPC_PROFILING
	int32_t rpc_par0;
	try {
	...
	rpc_io->Flush();
	msg.Receive(*rpc_io);
	msg.Check(rpc_clientCallId,16);
	rpc_par0 = msg.Get_INT32();
	rpc_par3 = msg.Get_INT32();
	rpc_par4 = msg.Get_INT32();
...
int32_t CTestboard::SCurveColumn(int32_t rpc_par1, int32_t rpc_par2, int32_t rpc_par3, int32_t &rpc_par4, int32_t &rpc_par5, int32_t &rpc_par6, int32_t &rpc_par7)
{ RPC_PROFILING
	int32_t rpc_par0;
	try {
	...
	rpc_io->Flush();
	msg.Receive(*rpc_io);
	msg.Check(rpc_clientCallId,20);
	rpc_par0 = msg.Get_INT32();
	rpc_par4 = msg.Get_INT32();
	rpc_par5 = msg.Get_INT32();
	rpc_par6 = msg.Get_INT32();
	rpc_par7 = msg.Get_INT32();
	RPC_THREAD_UNLOCK
